...
# Take a Yelp Website URL as Input from user
url = input('Enter a Yelp Business Url- ')
...
for script in soup.findAll('script',
                           attrs={'data-hypernova-key':
                                      'yelp_main__02006bb1cd717585d09de8af0d3cb8c8190a0379__yelp_main__BizDetailsApp__dynamic'}):
    ...
    for review in json_data["bizDetailsPageProps"]["reviewFeedQueryProps"]["reviews"]:
        review_json = {"comment": review["comment"]["text"], "rating": review["rating"]}
    ...
    for timing in json_data["bizDetailsPageProps"]["bizHoursProps"]["hoursInfoRows"]:
        timing_json = {"hours": timing["hoursInfo"]["hours"], "day": timing["hoursInfo"]["day"]}
